		  			...
		  			<div class="content-box-large">
		  				<div class="panel-heading" style="margin: 0 auto;">
							<div class="panel-title" style="float: right">
								<button class="btn btn-primary btn-lg" disabled >Add Collection <i class="glyphicon glyphicon-plus-sign"></i>  </button>
							</div>
						</div>
		  				<div class="panel-body">		  					
				 	 		<div class="col-md-12">
		  						<div class="row">
		  							<div class="col-md-4" ><img src="images/facebook.png" style="width: 100%; height: 200px;">
		  								<button class="btn btn-primary btn-lg" > <i class="glyphicon glyphicon-plus-sign"></i> <a href="bookdetails" style="color: #fff; text-decoration: none;">  &nbsp Add Book </a>   </button>
		  							</div>
		  							<div class="col-md-4" ><img src="images/facebook.png" style="width: 100%; height: 200px;">
		  							<button class="btn btn-primary btn-lg" > <i class="glyphicon glyphicon-plus-sign"></i><a href="bookdetails" style="color: #fff; text-decoration: none;">  &nbsp Add Book  </a> </button>
		  							</div>
