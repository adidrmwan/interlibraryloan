	     ...
	     <div class="container">
	        <div class="row">
	           <div class="col-md-5">
	              <!-- Logo -->
	              <div class="logo">
	                 <h1><a href="adminlibrary">INTER LIBRARY LOAN</a></h1>
	              </div>
	           </div>
	     	...
	     	<div class="row">
	     		<div class="navbar navbar-inverse" role="banner">
	                  <nav class="collapse navbar-collapse bs-navbar-collapse navbar-left" role="navigation">
	                    <ul class="nav navbar-nav">
	        				<li><a href="adminlibrary"><i class="glyphicon glyphicon-home"></i> Home </a> </li>
	                    </ul>
	                  </nav>
	              </div>
	     	</div>
		  				...
		  				<div class="panel-body">
				              ...
				              <tbody>
				                <tr>
				                  ...
				                  <td><button class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-pencil"></i> Edit</button>
                      			  </td>
                      			  <td><button class="btn btn-danger btn-xs" ><i class="glyphicon glyphicon-remove"></i> Delete</button></td>
				                ...
				                <tr>
				                  ...
				                  <td><button class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-pencil"></i> Edit</button>
                      			  ...
                      			  <td><button class="btn btn-danger btn-xs" ><i class="glyphicon glyphicon-remove"></i> Delete</button></td></tr>
				                <tr>
				                  <td>3</td>
				                  <td>5115100709</td>
				                  <td>Febri</td>
