		  			...
		  			<div class="content-box-large">
		  				...
		  				<div class="panel-body">		  					
				 	 		<div class="col-md-12">
		  						<div class="row">
		  							<div class="col-md-4" >
		  								<img src="images/facebook.png" style="width: 100%; height: 200px;">
		  								
		  								<button class="btn btn-primary" style="margin-top: 25px;"><i class="glyphicon glyphicon-pencil"></i> Edit Details</button>
		  				...
		  				<div class="col-md-12">
				  			<div class="content-box-large box-with-header">
				  				<h5>Name &emsp; &emsp; &emsp;  &nbsp;: The Book of Azka </h5>
				  				<h5>Author &emsp; &emsp; &emsp; : Azka Yasin</h5>
				  				<h5>Release Date  &nbsp; : 30 Februari 2018</h5>
				  				<h5>Categories &emsp; &nbsp;  : Novel</h5>
				  				<h5>Content &emsp; &emsp; &nbsp; : Horror, Religi</h5>
				  				<h5> Library&emsp; &emsp; &emsp;  : Ruang Baca Statistika</h5>
				  				<h5>Availability &emsp; &nbsp; : Available</h5>
				  				<h5>Description &nbsp; &nbsp; &nbsp; :</h5>
				  				<h5>Pellentesque luctus quam quis consequat vulputate. Sed sit amet diam ipsum. Praesent in pellentesque diam, sit amet dignissim erat. Aliquam erat volutpat. Aenean laoreet metus leo, laoreet feugiat enim suscipit quis. Praesent mauris mauris, ornare vitae tincidunt sed, hendrerit eget augue. Nam nec vestibulum nisi, eu dignissim nulla.
								</h5>
